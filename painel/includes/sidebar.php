<div id="sidebar">
	...
	<div class="user_box dark_box clearfix">
		<img src="<?php echo $urlGeral; ?>/images/profile.jpg" width="55" alt="Profile Pic" />
		<h2>Administrator</h2>
	...
	<ul class="side_accordion"> <!-- add class 'open_multiple' to change to from accordion to toggles -->
		<li><a href="#"><img src="<?php echo $urlGeral; ?>/images/icons/small/grey/home.png"/>Home</a>
			<ul class="drawer">
		...
		<li><a href="#"><img src="<?php echo $urlGeral; ?>/images/icons/small/grey/mail.png"/>Mailbox<span class="alert badge alert_red">5</span></a>
			<ul class="drawer">
		...
		<li><a href="#"><img src="<?php echo $urlGeral; ?>/images/icons/small/grey/documents.png"/>Documents<span class="alert badge alert_black">2</span></a>
			<ul class="drawer">
		...
		<li><a href="#"><img src="<?php echo $urlGeral; ?>/images/icons/small/grey/users.png"/>Members</a>
			<ul class="drawer">
		...
		<li><a href="http://www.tricycle.ie"><img src="<?php echo $urlGeral; ?>/images/icons/small/grey/graph.png"/>Statistics</a></li>
		<li><a href="#"><img src="<?php echo $urlGeral; ?>/images/icons/small/grey/cog_2.png"/>Settings</a>
			<ul class="drawer">
