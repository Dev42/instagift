...
?>
			...
			<?php include $_SERVER['DOCUMENT_ROOT'] . '/painel/includes/sidebar.php' ?>
				...
				<?php $keyphrase = '5'; include $_SERVER['DOCUMENT_ROOT'] . '/painel/includes/navigation.php';?>
                                    <div class="grid_16">
					...
					<div class="box grid_16">
                                                <div class="block">
                                                    <form action="<?php echo $urlUser;?>/action/crudAdmin.php?op=novo" method="post">
                                                        <fieldset class="label_side">
                                                                <label for="nome">Nome</label>
                                                                <div>
                                                                    <input title="Nome de identificação do administrador." name="nome" id="nome" class="tooltip right" type="text">
