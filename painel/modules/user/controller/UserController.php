...
class UserController {
    ...
    public function insertAction(User $user) {
	    ...
	    $user->encriptPassword();
            ...
            $strQuery = "INSERT INTO `" . $user->tableName() . "` (`" . $fields . "`) VALUES('" . $values . "');";
    ...
    public function editAction(User $user){
        ...
        if ($user->getLogin() != "" && $user->getNome() != "" && $user->getContato() != "" && $user->getTelefone() != "" && $user->getEmail() != "") {
            ...
            $sqlQuery = "UPDATE `".$user->tableName()."` SET $setQuery WHERE `user_10_id` = ". $user->getId();
    ...
    public function deleteAction(User $user){
        ...
        if ($user->getId() != "") {
            ...
            $sqlQuery = "DELETE FROM `".$user->tableName()."` WHERE `user_10_id` = ". $user->getId();
            mysql_query($sqlQuery);
