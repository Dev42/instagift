...
class AdminController {
    ...
    public function insertAction(User $user) {
        ...
        if ($user->getLogin() != "" && $user->getNome() != "" && $user->getSenha() != "" && $user->getEmail() != "") {
            ...
            $strQuery = "INSERT INTO `fotu_net_br`.`" . $user->tableName() . "` (`" . $fields . "`) VALUES('" . $values . "');";
    ...
    public function editAction(User $user){
        ...
        if ($user->getLogin() != "" && $user->getNome() != "" && $user->getEmail() != "") {
            ...
            $sqlQuery = "UPDATE `fotu_net_br`.`".$user->tableName()."` SET $setQuery WHERE `user_10_id` = ". $user->getId();
    ...
    public function deleteAction(User $user){
        ...
        if ($user->getId() != "") {
            ...
            $sqlQuery = "DELETE FROM `fotu_net_br`.`".$user->tableName()."` WHERE `user_10_id` = ". $user->getId();
            mysql_query($sqlQuery);
