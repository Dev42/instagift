...
?>
			...
			<?php include $_SERVER['DOCUMENT_ROOT'] . '/site/painel/includes/sidebar.php' ?>
				<div id="main_container" class="main_container container_16 clearfix">
                                    <?php $keyphrase = '2'; include $_SERVER['DOCUMENT_ROOT'] . '/site/painel/includes/navigation.php'; ?>
                                                ...
                                                <div class="alert dismissible alert_<?php echo ( ($_GET['type'] == "success")? "green" : "red" ); ?>">
                                                    ...
                                                    if ($_GET['type'] == "success"){
                                                        ...
                                                        if ($_GET['erron'] == 1){
                                                            ...
                                                            $strErro = "Erro ao $compErro usuário, registro não encontrado!";
                                                        }elseif ($_GET['erron'] == 4 && isset($compErro)){
                                                            $strErro = "Erro ao $compErro usuário, login já existente!";
                                                        }
                                                    }
                                                    echo $strErro;
                                                    ?>
                                                ...
                                                <table class="display datatable"> 
                                                    ...
                                                    <tbody> 
                                                            ...
                                                            foreach ($userList as $k => $v){
                                                                ...
                                                                echo '<td>
                                                                        <a href="'.$urlUser.'/editarFornecedor.php?id='.$v['user_10_id'].'"><img src="'.$urlGeral.'/images/icons/personal/edit.png"/></a>
                                                                        <a href="'.$urlUser.'/deletarFornecedor.php?id='.$v['user_10_id'].'"><img src="'.$urlGeral.'/images/icons/personal/trash.gif"/></a>
                                                                     </td>';
                                                                echo '</tr>';
                                                            }
