...
switch ($op) {
    case "novo":
        ...
        if (isset($_POST)){
            ...
            if ($login != "" && $nome != "" && $rg != "" && $cpf != "" && $telefone != "" && $email != "" && $endereco != "" && $senha != ""){
                ...
                $userClass->setContato($nome);
				$userClass->setDoc1($rg);
				$userClass->setDoc2($cpf);
                ...
                if (count($userVer) == 0){
                    ...
                    header("Location: cadastro.php?type=error&case=novo&erron=4");
                }
            }else{
                header("Location: cadastro.php?type=error&case=novo&erron=1");
            }
        }else {
