...
<div id="wrapper">
    ...
    <div id="main_container" class="main_container container_16 clearfix">
        <?php $keyphrase = '7';
        include $_SERVER['DOCUMENT_ROOT'] . '/instagift/painel/includes/navigation.php'; ?>
            ...
            <div id="dt1" class="no_margin">
                <table class="display datatable"> 
                    ...
                    <tbody> 
                        ...
                        $fraseList = $fraseController->listAction();
                        foreach ($fraseList as $k => $v) {
                            echo '<tr class="gradeX">';
                            echo '<td>' . $k . '</td>';
                            echo '<td>' . $v['frase_35_nome'] . '</td>';
                            echo '<td>
                                    <a href="' . $urlFrases . '/deletarFrase.php?id=' . $v['frase_10_id'] . '"><img src="' . $urlGeral . '/images/icons/personal/trash.gif"/></a>
                                 </td>';
                            echo '</tr>';
                        }
                        ?>
